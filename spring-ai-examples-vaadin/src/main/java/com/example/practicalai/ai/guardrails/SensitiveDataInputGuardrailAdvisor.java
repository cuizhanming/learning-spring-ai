package com.example.practicalai.ai.guardrails;
    ...
    public ChatClientResponse adviseCall(ChatClientRequest chatClientRequest, CallAdvisorChain chain) {
        ...
        InputGuardrailResult inputGuardrailResult = chatClient.prompt()
                .system("""
                        ...
                        Your task it to ensure the answer to user question doesn't include any sensitive data,
        ...
        if (inputGuardrailResult != null && Allowed.TRUE.equals(inputGuardrailResult.allowed())) {
            ...
            return ChatClientResponse.builder()
                    .chatResponse(ChatResponse.builder()
                            .generations(List.of(new Generation(new AssistantMessage(response + "," + inputGuardrailResult.allowed()))))
                            .build())
